...
import plistlib,sys
app=Path(sys.argv[1])
p=dict(CFBundleExecutable='Starfolio',CFBundleIdentifier='com.starfolio.wallpaper',CFBundleName='Starfolio',CFBundleIconFile='AppIcon',LSMultipleInstancesProhibited=True,CFBundleDisplayName='Starfolio',CFBundlePackageType='APPL',CFBundleShortVersionString='0.1.0',CFBundleVersion='1',LSMinimumSystemVersion='15.0',NSPrincipalClass='NSApplication',CFBundleDevelopmentRegion='en',CFBundleLocalizations=['en','zh-Hans','ko'],NSHumanReadableCopyright='Starfolio. Image credits are included in the application.')
